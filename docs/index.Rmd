...
---
# Função filter
Permite filtrar observações de uma base a partir de alguma condição. 

```{r filter, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE, r echo = T, results='hide'}
gem_especialistas %>%  
